...
public class RequestedBookControllerApi {
   ...
   * 
   * Dummy request body: { "name": "Api tutorial", "language": "English", "type":
   * "type", "writterName": "Mr. Hello" }
   * 
   * Dummy response body: { "book object": { "id": 1, "type": "type", "name": "Api
   * tutorial", "author": "Mr. Hello", "language": "English", "isAvailable": false
   * }, "message": "New book added", "status": "Sueccess!" }
   * 
   * @param BookJson
   * @return
   * @throws IOException
  ...
  public HashMap<String, Object> addRequestedBookPostMapping(@RequestBody String BookJson) throws IOException {
   ...
   * 
   * 
   * Response body: [ { "id": 1, "type": "type", "name": "Api tutorial", "author":
   * "Mr. Hello", "language": "English", "isAvailable": false } ]
   * 
   * @param model
   * @return
   */
