...
public class PostController {
  ...
  @PostMapping("/addPost")
  public String addBookPost(@RequestParam(name = "title", required = true, defaultValue = "") String title,
      @RequestParam(name = "body", required = true, defaultValue = "") String body, Authentication authentication)
      throws IOException {
