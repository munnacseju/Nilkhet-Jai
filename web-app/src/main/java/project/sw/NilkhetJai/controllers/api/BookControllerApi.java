...
public class BookControllerApi {
  ...
  /**
   * showAllBooks is a GetMapping api function which shows all books API url:->
   * localhost:8027/api/showBooks
   * 
   * Dummy request body: null
   * 
   * 
   * Dummy respose body: [ { "id": 1, "type": "CSE", "name": "Dummy book",
   * "author": "Mr. X Uddin", "language": "English", "fileType": null,
   * "numberOfBooks": 10, "isAvailable": true, "filefileData": null }, { "id": 2,
   * "type": "Bank", "name": "Pattrol", "author": "Mr. X Uddin", "language":
   * "Bangla", "fileType": null, "numberOfBooks": 10, "isAvailable": true,
   * "filefileData": null }, { ]
   * 
   * 
   * @return
   ...
   * 
   * Dummy request body: { "name": "Api tutorial", "language": "English",
   * "numberOfBooks": "13", "type": "type", "writterName": "Mr. Hello" }
   * 
   * Dummy response body:
   * 
   * { "book object": { "id": 9, "type": "type", "name": "Api tutorial", "author":
   * "Mr. Hello", "language": "English", "fileType": null, "numberOfBooks": 13,
   * "isAvailable": true, "filefileData": null }, "message": "New book added",
   * "status": "Sueccess!" }
   * 
   * 
   * @param multipartFile
   ...
   * 
   * Api url:-> localhost:8027/api/bookDetails/{id} example:->
   * localhost:8027/api/bookDetails/3
   * 
   * Dummy request body: null
   * 
   * Dummy response body: { "id": 3, "type": "Bank", "name": "Pattrol", "author":
   * "Mr. X Uddin", "language": "Bangla", "fileType": null, "numberOfBooks": 10,
   * "isAvailable": true, "filefileData": null }
   * 
   * @param id
   * @return
   */
