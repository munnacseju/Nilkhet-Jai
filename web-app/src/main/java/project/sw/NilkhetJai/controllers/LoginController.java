...
public class LoginController {
  ...
  public String viewUserRegistrationPage(
      @RequestParam(name = "username", required = false, defaultValue = "") String username, User user, Model model,
  ...
  public String registerUser(@RequestParam(name = "email", required = false, defaultValue = "") String email,
    ...
    if (!confirmPassword.equals(password)) {
      redirectAttributes.addFlashAttribute("confirmPasswordError", "Password and confirm password does not matched!");
      redirectAttributes.addFlashAttribute("firstName", firstName);
      redirectAttributes.addFlashAttribute("lastName", lastName);
      redirectAttributes.addFlashAttribute("email", email);
